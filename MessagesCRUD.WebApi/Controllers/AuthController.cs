...
using MessagesCRUD.WebApi.Models;
...
namespace MessagesCRUD.WebApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterViewModel viewModel)
        {
            ...
            if (userExists != null)
            {
                return StatusCode(StatusCodes.Status500InternalServerError,
                    new Response { Status = "Error", Message = "User already exsists!" });
            }
        ...
        public async Task<IActionResult> RegisterAdmin([FromBody] RegisterViewModel viewModel)
        {
            var userExists = await _userManager.FindByNameAsync(viewModel.Username);
            if (userExists != null)
            {
